...
export function SideCard({
  ...
  return (
    <article
      className={`grid  grid-cols-[130px_1fr] sm:grid-cols-[160px_1fr] md:grid-cols-[260px_1fr] gap-3 rounded-xl border bg-card/60 p-4 h-full overflow-hidden ${className}`}
    >
      {/* Image */}
