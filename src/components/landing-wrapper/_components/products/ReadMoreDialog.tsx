      ...
      <DialogContent className="max-w-6xl w-[95vw] max-h-[90vh] rounded-xl overflow-hidden ">
        ...
        <div className="w-full flex justify-center">
          <div style={{ width: "min(90vw, 70vh)" }}>
            <div
              className={`mt-3 rounded-xl p-3 overflow-x-auto no-scrollbar ${
                dragging ? "dragging" : ""
              }`}
              ref={thumbsRef}
                    ...
                    (thumb, index) =>
                      thumb && (
                        <button
                          ...
                          className={`relative w-16 h-16 shrink-0 rounded-md overflow-hidden ring-offset-2 transition-all duration-200 cursor-pointer ${
                            activeIndex === index
