        ...
        return (
            <div className="min-h-screen bg-[#F4F4F4] flex items-center justify-center p-6">
                <div className="text-center">
                    <h1 className="text-2xl sm:text-3xl font-semibold text-primary-color">News not found</h1>
                    <p className="mt-2 text-gray-600">We couldn't find the article you're looking for.</p>
                    <button
    ...
    return (
        <div className="min-h-screen bg-[#F4F4F4]">
            ...
            <section className="relative h-[220px] sm:h-[280px] lg:h-[340px] w-full overflow-hidden">
                <Image src="/newsPage.png" alt="News hero" fill className="object-cover" priority />
                    ...
                    <div className="text-center text-white px-4">
                        ...
                        <nav className="mt-3 text-xs sm:text-sm opacity-90">
                            <ol className="flex items-center justify-center gap-2">
                                ...
                                <li className="opacity-70">/</li>
                                <li className="opacity-100 line-clamp-1 max-w-[40vw]">{current?.title || "Detail"}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
